<template lang="pug">
  b-modal#privacyModal(size="lg", title="Privacy Policy", ok-only='')
    h1 Privacy Policy
    p.text-muted Effective date: December 04, 2018
    p.text-muted
      | Swift Dry Cleaners ("us", "we", or "our") operates the https://www.swiftdrycleaners.co.za website (the "Service").
    p.text-muted
      | This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
      //a(href='https://www.freeprivacypolicy.com/free-privacy-policy-generator.php') Free Privacy Policy Website
      | .
    p.text-muted
      | We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://www.swiftdrycleaners.co.za
    ...
    p.text-muted Examples of Cookies we use:
    ul
      li
    ...
    h2 Use of Data
    p.text-muted Swift Dry Cleaners South Africa uses the collected data for various purposes:
    ul
      li To provide and maintain the Service
      ...
      li To monitor the usage of the Service
    ...
    p.text-muted
      | Swift Dry Cleaners South Africa will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.
    h2 Disclosure Of Data
    h3 Legal Requirements
    p.text-muted
      | Swift Dry Cleaners South Africa may disclose your Personal Data in the good faith belief that such action is necessary to:
    ul
      li To comply with a legal obligation
      li To protect and defend the rights or property of Swift Dry Cleaners South Africa
    ...
    p.text-muted Our Service does not address anyone under the age of 18 ("Children").
    p.text-muted
    ...
    h2 Contact Us
    p.text-muted If you have any questions about this Privacy Policy, please contact us:
    ul
      li By email: info@swiftdrycleaners.co.za
